...
<!--CSS DO FORM DE LOGIN-->
    ...
    <div class="container d-flex justify-content-center" style="padding-top: 40px; padding-bottom: 40px">
       <div class="form-row align-items-center fundo">
		

		<form method="post" action="logar.php" style="margin:50px">
		...
		<center><br><button type="submit" class="btn btn-dark">Logar</button></center>
		<br>
		<center>
